...
myManageHook = composeAll . concat $
    ...
    , [className =? c --> (doRectFloat myRect) | c <- myFileManager]
    ...
    myCFloats = ["Dolphin", "Blueberry.py", "Archlinux-logout.py", "Arandr", "Arcolinux-calamares-tool.py", "Archlinux-tweak-tool.py", "Arcolinux-welcome-app.py", "Galculator", "feh", "mpv", "Xfce4-terminal"]
    myTFloats = ["Downloads", "Save As..."]
    myFileManager = ["Thunar"]
    myRFloats = []
    myIgnores = ["desktop_window"]
    myRect = W.RationalRect (1 % 4) (1 % 4) (1 % 2) (1 % 2)
...
nordStringColorizer :: String -> Bool -> X (String, String)
nordStringColorizer _ isSelected = return $ if isSelected
    then ("#6790EB", "#f3f4f5") -- Active: Background, Foreground
    else ("#1e1e1e", "#ABABAB") -- Inactive: Background, Foreground


gsconfig2 :: (String -> Bool -> X (String, String)) -> GSConfig String
gsconfig2 colorizer = (buildDefaultGSConfig colorizer) { 
    ...
    , gs_originFractX = 0.5
    , gs_originFractY = 0.5
    , gs_font = "xft:Iosevka Nerd Font:size=10"
    }
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  , ((modMask, xK_w), spawn $ "rofi -show drun -show-icons" )
  ...
  , ((modMask, xK_l), spawn $ "betterlockscreen -l" )
    ...
    , ((modMask, xK_e), spawnSelected  (gsconfig2 nordStringColorizer) gridSelectApps)
